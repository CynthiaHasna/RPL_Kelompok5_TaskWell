...
<body style="cursor: url('./../Homes/Asset/cursor.png') 0 0, auto;">
 ...
 <form id="kelasForm" method="POST" action="../../simpan_kelas.php">
      ...
      <div class="button-group">
        ...
        <button type="submit" class="btn" name="simpan_kelas">Lanjutkan</button>
    </div>
</form>
  </div>
  ...
  document.getElementById('kelasForm').addEventListener('submit', function(e) {
    ...
    if (this.checkValidity()) {
      // Simpan data ke server dengan AJAX (opsional) atau langsung redirect
      // window.location.href = 'codeguru.html';

      // ATAU jika kamu tetap ingin kirim data ke simpan_kelas.php, pakai FormData
      const formData = new FormData(this);

      fetch('simpan_kelas.php', {
        method: 'POST',
        body: formData
      })
      .then(response => {
