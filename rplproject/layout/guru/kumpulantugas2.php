      ...
      <div class="overlay">
        <div class="task-container">
         <div class="tabs">
          ...
          <a href="kumpulantugas2.php" class="active">Kumpulan Tugas</a>
        </div>
...
<div class="task-section" id="taskSectionContainer">
          <div class="section-title"><?= $t['nama_tugas']; ?></div> <!-- Misal ditambahkan pertemuan -->
<div class="task-card" onclick="window.location.href='kumpulantugas.php?id_tugas=<?= $t['id_tugas']; ?>'" style="cursor: pointer;">
            <div class="task-left">
              <img src="../../gambar/pdf.png" alt="PDF" width="40">
              <div>
                <div class="task-title"><?= $t['nama_tugas']; ?></div>
                <div class="task-difficulty <?= strtolower($t['level']); ?>"><?= $t['level']; ?></div>
              </div>
            </div>
