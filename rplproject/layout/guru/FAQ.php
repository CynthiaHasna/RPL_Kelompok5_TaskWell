...
// Mengecek apakah username sudah diset dalam session
      ...
      <div class="faq">
        <div class="faq-item active">
          <div class="faq-question">
            Bagaimana cara membuat kelas baru di TaskWell?
            <span class="arrow">▾</span>
          </div>
          <div class="faq-answer">
          Guru dapat membuat kelas dengan mengisi nama kelas dan mata pelajaran, lalu akan mendapatkan kode kelas untuk dibagikan ke siswa.
          </div>
        </div>

        <div class="faq-item">
          <div class="faq-question">
          Bagaimana cara memberikan tugas kepada siswa?
            <span class="arrow">▾</span>
          </div>
          <div class="faq-answer">
          Guru dapat menambahkan tugas secara digital ke kelas yang telah dibuat, mengatur tenggat waktu, dan memilih tingkat kesulitan tugas sesuai kebutuhan siswa.          </div>
        </div>
