...
// Ambil data tugas
$result = mysqli_query($koneksi, "SELECT * FROM tugas WHERE id_tugas = $id_tugas");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE tugas SET nama_tugas='$nama_tugas', deskripsi='$deskripsi', level='$level' WHERE id_tugas = $id_tugas";
    mysqli_query($koneksi, $query);

    header("Location: forum.php?id_kelas={$tugas['id_kelas']}");
    exit;
}
?>
