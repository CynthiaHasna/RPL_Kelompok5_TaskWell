  ...
  <style>
    * {
    ...
    .subtitle {
      font-size: 28px;
      color: #333;
      margin-top: -30px; /* Atau bisa juga pakai margin-top: 2px; sesuai kebutuhan */
...
justify-content: center;  
  ...
  button:hover {
    ...
    .tabs a {
      ...
      transition: background-color 0.3s ease, color 0.3s ease;
      cursor: pointer;
      background-color: transparent; /* default tanpa warna */
    }
    ...
    .pet-image {
      width: 120px;
      height: 120px;
      background-image: url('../../gambar/pet.png');
      background-size: contain;
      background-repeat: no-repeat;
      background-position: center;
      padding: 2px;
    ...
    .course-button:hover {
  background-color:rgb(198, 166, 141); /* warna sedikit lebih gelap saat hover */
  color: #000;               /* tetap hitam */
  cursor: pointer;/* bayangan lebih tajam */
  ...
  <div class="container">
    <div class="sidebar" id="sidebar">
      ...
      <!-- Garis pemisah -->
        ...
        <div class="sidebar-courses">
          <a href="BerandaKurpem.php" class="a-navbar">
          <div class="course-button">
            <strong>KURIKULUM PEMBELAJARAN</strong><br>
            <small>Guru. Kartika Diana</small>
            </a>
          </div>
           <a href="BerandaAlpro.php" class="a-navbar">
           <div class="course-button">
    ...
    <div class="main-content">
      ...
      <div class="overlay">
        ...
        <div class="tabs">
        <a href="#" onclick="history.back(); return false;">Forum</a>
      ...
      <div class="task-section">
        ...
        <div class="task-card">
          <div class="task-left">
            <div class="task-icon">
                <img src="../../gambar/pdf.png" alt="PDF" />
            </div>            
          <div>
              <div onclick="window.location.href='SubmitHard.php'" style="cursor: pointer; color: black; text-decoration:none;">
  Tugas Pertemuan Kerangka Perangkat
</div>

              <div class="tag hard">hard</div>
            </div>
          </div>
          <div class="deadline">Tenggat: 13 Januari 2080, 23.59</div>
        </div>
...
<div class="task-card">
  <div class="task-left">
    ...
    <div>
      <div onclick="window.location.href='SubmitMedium.php'" style="cursor: pointer; color: black; text-decoration:none;"> Tugas Merangkum 5 baris </div>
...
<div class="task-card">
  <div class="task-left">
    ...
    <div>
      <div onclick="window.location.href='SubmitEasy.php'" style="cursor: pointer; color: black; text-decoration:none;"> Tugas Makalah EPIK </div>
      <div class="tag easy">easy</div>
    </div>
  </div>
  <div class="deadline">Tenggat: 16 Januari 2026, 23.59</div>
</div>
