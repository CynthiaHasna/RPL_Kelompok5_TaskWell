  ...
  <style>
    * {
    ...
    a.active {
      ...
      padding: 8px 12px;          
      border-radius: 6px;         /* Opsional, biar sudut membulat */
      display: inline-block;      /* Biar padding dan border terlihat */
    }
    ...
    .pet-image {
      width: 120px;
      height: 120px;
      background-image: url('../../gambar/CapyLove.png');
    ...
    <div class="main-content">
      <div class="overlay">
        <div class="task-container">
          <div class="tabs">
            <span>Forum</span>
            <a href="Tugas.php" class="active">Kumpulan Tugas</a>
          ...
          <div class="task-wrapper">
            <div class="task-highlight-box">
              <div class="task-content">
                <p class="task-title">Kerjain tugas mu yuk!</p>
                <img src="../../gambar/study.png" alt="Capybara" />
                <a href="SubmitMedium.php" class="pdf-button">
