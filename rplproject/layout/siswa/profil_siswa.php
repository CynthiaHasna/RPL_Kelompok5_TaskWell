...
<body style="cursor: url('../../Homes/Asset/cursor.png') 0 0, auto;">
  ...
  <div class="container">
    <div class="sidebar">
      ...
      <button> <a href="TingkatanTugas.html" class="a-navbar">Tingkatan Tugas</a></button>
      <button> <a href="#" class="a-navbar">Profil</a></button>
...
function setProfileImage(imgElement) {
  ...
  profileImage.style.backgroundImage = `url('${imgElement.src}')`;
...
// 💡 PENTING: Tambahkan ini di luar fungsi
